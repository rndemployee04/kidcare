...
Route::get('/playpal/parent/{id}', function ($id) {
    ...
    return view('playpal.parent-profile', [
        ...
        'zip' => $parent->zip ?? 'N/A',
        'service_radius' => $parent->preferred_radius ? $parent->preferred_radius . ' km' : 'N/A',
        'number_needing_care' => $parent->number_needing_care ?? 'N/A',
        'availability' =>  is_array($parent->preferred_drop_off_time) ? implode(', ', $parent->preferred_drop_off_time) : $parent->preferred_drop_off_time ?? 'N/A' ,
