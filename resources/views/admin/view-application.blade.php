        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            @if($user->role === 'carebuddy' && $user->careBuddy)
                <div class="mb-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div><strong>Background Check Consent:</strong>
            ...
            <div class="flex space-x-4 mt-6">
                ...
                @elseif($user->verification_status == 'approved')
                    <span class="bg-green-100 text-green-800 px-4 py-2 rounded">Approved</span>
                @elseif($user->verification_status == 'rejected')
                    <span class="bg-red-100 text-red-800 px-4 py-2 rounded">Rejected</span>
                @endif
