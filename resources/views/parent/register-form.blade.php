    ...
    <form wire:submit.prevent="submit" class="space-y-8">
        ...
        <div>
            ...
            <input type="file" wire:model="id_proof_path" id="id_proof_path"
                class="w-full file:bg-orange-500 file:text-white file:px-4 file:py-2 file:rounded-md file:border-0 bg-slate-100 dark:bg-orange-500 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-600 rounded-md" required>
