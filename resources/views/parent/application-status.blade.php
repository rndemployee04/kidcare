    ...
    <div class="max-w-lg w-full mx-auto bg-white/90 border border-gray-200 rounded-2xl shadow-xl p-10 text-center">
        ...
        @if ($status === 'pending')
            <div class="flex flex-col items-center mb-6">
                ...
                <p class="mb-4 text-gray-700">Your application has been submitted and is currently under review.<br>You
                    will be notified once it is verified.</p>
            </div>
        @elseif ($status === 'rejected')
            <div class="flex flex-col items-center mb-6">
                ...
                <p class="mb-4 text-gray-700">Unfortunately, your application was rejected.<br>Please contact support
        ...
        <div class="flex flex-col items-center justify-center gap-4 mt-8 w-full">
            <div class="flex flex-col md:flex-row gap-4 w-full justify-center items-center">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="w-40 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md font-semibold shadow-sm transition cursor-pointer">
                        <i class="fas fa-sign-out-alt mr-2"></i>Logout
                    </button>
                </form>
                <a href="#"
                    class="w-40 px-4 py-2 border border-blue-400 text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-md font-semibold shadow-sm transition text-center cursor-pointer flex items-center justify-center">
