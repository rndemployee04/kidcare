...
<div class="container mx-auto py-8">
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-8">
            ...
            <!-- Carebuddy Details -->
            <div class="bg-gray-50 rounded-lg p-6">
                <h3 class="text-xl font-semibold mb-4">Carebuddy Details</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <p class="text-gray-600 mb-1">Name</p>
                        <span class="font-medium">{{ $booking->carebuddy->user->name }}</span>
                    </div>
                    <div>
                        <p class="text-gray-600 mb-1">Email</p>
                        <span class="font-medium">{{ $booking->carebuddy->user->email }}</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span class="font-medium">
                            @if($booking->carebuddy->background_check_consent)
                    ...
                    @if($booking->carebuddy->profile_photo)
                        <div class="col-span-2">
                            <p class="text-gray-600 mb-1">Profile Photo</p>
                            <img src="{{ asset('storage/' . $booking->carebuddy->profile_photo) }}" 
                                alt="{{ $booking->carebuddy->user->name }}'s profile photo" 
                ...
                <div class="space-y-4">
                    ...
                    @if($booking->carebuddy_accepted)
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-900">Accepted by Carebuddy</p>
