...
<x-layouts.onboarding class="max-w-4xl mx-auto px-6 py-12 text-slate-900 dark:text-slate-100 min-h-screen flex items-center justify-center">
    <div class="w-full">
        <x-auth-header :title="__('Resume CareBuddy Registration')" :description="__('You need to finish your registration before accessing your dashboard.')" />
        <div class="mb-8">
            <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-5 rounded-lg shadow flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm">Please complete your CareBuddy profile to access all features and your dashboard.</p>
                </div>
            </div>
        </div>
